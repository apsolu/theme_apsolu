...
$filearea = 'homepage';
$url = new moodle_url($CFG->wwwroot.'/theme/apsolu/documents/public/contact.php');

$PAGE->set_url($url);
$PAGE->set_title(get_string('contact_us', $component));
$PAGE->set_heading(get_string('contact_us', $component));
