...
/**
 * Page des paramètres de personnalisation.
 *
...
if (empty($defaults->homepage_footer_logo_1) === true) {
    file_prepare_draft_area(
        $defaults->homepage_footer_logo_1,
        $syscontext->id,
        $component,
        $filearea,
        THEME_APSOLU_HOMEPAGE_FOOTER_LOGO_1,
        $filemanageroptions
    );
}
...
if (empty($defaults->homepage_footer_logo_2) === true) {
    file_prepare_draft_area(
        $defaults->homepage_footer_logo_2,
        $syscontext->id,
        'theme_apsolu',
        'homepage',
        THEME_APSOLU_HOMEPAGE_FOOTER_LOGO_2,
        $filemanageroptions
    );
}
...
if (empty($defaults->homepage_footer_logo_3) === true) {
    file_prepare_draft_area(
        $defaults->homepage_footer_logo_3,
        $syscontext->id,
        'theme_apsolu',
        'homepage',
        THEME_APSOLU_HOMEPAGE_FOOTER_LOGO_3,
        $filemanageroptions
    );
}
...
$defaults->footer_text_section = file_prepare_standard_editor(
    $defaults,
    'footer_text_section',
    $editoroptions,
    $syscontext,
